...
async function main() {
  ...
  const programData = [
    ...
    },
    {
      ...
      longDescription: 'A specialized recovery program designed specifically for women addressing unique needs and challenges in addiction recovery.',
      programType: 'SHELTER',
      schedule: 'Residential',
      location: '1675 Story Ave, Louisville, KY 40206',
      phone: '(502) 555-0103',
  ...
  const blogPostsData = [
    ...
    {
      title: "Introducing Our New Women's Program",
      slug: 'new-womens-program',
      content: 'We are excited to announce our specialized Women\'s Program, designed with trauma-informed care and unique needs in mind...',
      excerpt: 'New specialized program for women in recovery',
      authorId: adminUser.id,
      status: 'PUBLISHED' as const,
      ...
      tags: JSON.stringify(['womens-program', 'announcement', 'new-program'])
    }
  ]
  ...
  console.log(`   Users: ${userList} (all with password: TestPassword123!)`)
}
