                ...
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {isSession && 'format' in event && event.format && (
                  ...
                  <div className="flex flex-col items-start lg:items-end gap-2">
                    ...
                    {isSession && (
                      <a
                        href={`/api/meetings/ical?id=${event.id}`}
                        download
                        className="px-4 py-2 text-sm border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-100 transition inline-flex items-center gap-1"
                      >
