        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            ...
            <a href={socialStats.linkedin.url} target="_blank" rel="noopener noreferrer" aria-label="Follow us on LinkedIn" className="group bg-gradient-to-br from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-900 rounded-xl p-4 sm:p-5 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-700/20">
              <Linkedin className="w-7 h-7 mx-auto mb-2 text-white" aria-hidden="true" />
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Phone className="w-5 h-5 text-brand-green mt-0.5 flex-shrink-0" aria-hidden="true" />
                  <div>
                    <p className="text-xs text-gray-300">Call us anytime</p>
                    <a href="tel:+15027496344" className="text-white font-semibold hover:text-brand-green transition">(502) 749-6344</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Mail className="w-5 h-5 text-brand-green mt-0.5 flex-shrink-0" aria-hidden="true" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-brand-green mt-0.5 flex-shrink-0" aria-hidden="true" />
                  <div>
                    <p className="text-xs text-gray-300">Visit us</p>
              ...
              <div className="mt-6 pt-4 border-t border-white/10">
                <p className="text-xs text-gray-300 font-semibold uppercase mb-2">Ways to Give</p>
      ...
      <div className="border-t border-white/10 bg-black/30 px-4 py-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="pt-4 border-t border-white/10 space-y-2">
            <p className="text-gray-300 text-xs text-center font-semibold uppercase tracking-wider">Emergency Resources</p>
