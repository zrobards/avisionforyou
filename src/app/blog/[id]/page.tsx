...
const BLOG_POSTS = [
  {
    ...
    readTime: '3 min read',
    category: 'Recovery',
    content: `Starting a recovery journey is one of the most courageous decisions a person can make. It marks the beginning of a path toward healing, growth, and renewed purpose. Whether you're taking this step for yourself or for someone you love, understanding the power of this choice is essential.

The journey to recovery is deeply personal. Each person's path is unique, shaped by their individual circumstances, challenges, and strengths. What matters most is the decision to begin—to choose hope over despair, healing over suffering, and connection over isolation.

One of the most powerful aspects of recovery is the realization that you don't have to do it alone. Whether through professional support, community programs, or peer connections, recovery is built on the foundation of human connection and mutual support.

In our programs at A Vision For You, we've witnessed countless individuals transform their lives through commitment to their recovery journey. The power of choosing to begin is not just about stopping harmful behaviors—it's about building a new life filled with purpose, meaning, and genuine connection.

If you're standing at the crossroads, wondering whether to take that first step, know this: every person in recovery today started exactly where you are. The decision you make right now can set the course for the rest of your life.`,
  },
  {
    id: 2,
