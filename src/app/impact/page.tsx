        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-brand-purple to-purple-900 text-white rounded-2xl shadow-2xl p-8 md:p-12">
            ...
            <div className="space-y-4 text-purple-100 leading-relaxed">
              <p>
                A Vision For You Recovery operates with a commitment to evidence-based practices and transparent outcome measurement. Our comprehensive programs address the full spectrum of recovery needs—from immediate crisis intervention to long-term sustainability planning.
              </p>
              <p>
