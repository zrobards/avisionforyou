        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {socialChannels.map((channel, idx) => {
              ...
              return (
                <AnimateOnScroll key={idx} variant="fadeUp" delay={0.1 * idx}>
                  <a
                    href={channel.url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`block ${channel.bgColor} border-2 ${channel.borderColor} rounded-xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300 group`}
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {contentHighlights.map((content, idx) => (
              <AnimateOnScroll key={idx} variant="fadeUp" delay={0.1 * idx}>
                <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-brand-purple">
