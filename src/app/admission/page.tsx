                ...
                <div>
                  ...
                  <div className="mb-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-xs text-blue-800 font-medium">
                      <strong>Privacy Notice:</strong> Please do not include medical details, diagnosis information, or other protected health information (PHI) in your message. We will contact you to discuss details privately.
                    </p>
                  </div>
                  <textarea
