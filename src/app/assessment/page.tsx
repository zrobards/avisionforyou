...
const PROGRAM_DESCRIPTIONS = {
  ...
  WOMENS_PROGRAM: {
    ...
    description: "Specialized program for women",
    details: "A trauma-informed program specifically designed for women's unique recovery needs."
  }
}
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-4">
              <h1 className="text-2xl font-bold text-gray-900">Recovery Assessment</h1>
