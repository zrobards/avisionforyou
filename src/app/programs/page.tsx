    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <header className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-blue-100 mt-2">Comprehensive recovery services tailored to your needs</p>
        </div>
      </header>
          ...
          {PROGRAMS.map((program, index) => {
            ...
            return (
              ...
              >
                ...
                <p className={`text-sm mt-2 ${selectedProgram === index ? 'text-blue-100' : 'text-gray-600'}`}>
                  {program.category}
                </p>
              </button>
            )
