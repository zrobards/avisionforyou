...
import { Plus, Edit, Trash2, Eye, Save, Mail, Image as ImageIcon } from 'lucide-react'
        ...
        {creating && (
          <div className="bg-gray-800 rounded-lg p-6 mb-8 border border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="newsletter-image" className="block text-gray-300 font-semibold mb-2">Featured Image (optional)</label>
