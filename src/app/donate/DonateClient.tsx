        ...
        <div className="max-w-3xl mx-auto px-4">
          <AnimateOnScroll variant="scaleUp">
            <div className="rounded-3xl border border-white/10 bg-brand-dark-lighter shadow-2xl shadow-[#b6e41f]/5 p-6 sm:p-8 md:p-10">
              ...
              {/* ── Custom Amount ── */}
              <div className="mb-8">
                <label htmlFor="donate-custom-amount" className="block text-sm font-semibold text-white/70 mb-2">Or Enter Custom Amount</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 text-lg font-semibold" aria-hidden="true">
                    $
                  </span>
                  <input
              ...
              {/* ── Donor Info ── */}
              <div className="mb-8">
                <p className="block text-sm font-semibold text-white/70 mb-4">Your Information</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="donate-name" className="sr-only">Full Name</label>
                    <input
                      id="donate-name"
                      type="text"
                      value={name}
