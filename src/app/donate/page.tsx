        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-gradient-to-br from-purple-50 to-green-50 rounded-lg shadow-xl p-6 sm:p-8 md:p-10">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-lg mb-8">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Tax-Deductible Giving</h3>
              <div className="space-y-2 text-gray-700 text-sm">
                <p>
                  <strong>A Vision For You is a registered 501(c)(3) nonprofit organization.</strong> Contributions are tax-deductible to the extent permitted by law.
                </p>
                <p>
                  Donations are voluntary and no goods or services are provided in exchange. You will receive a tax receipt via email within 24 hours of your donation.
                </p>
            ...
            <div className="mt-6 flex flex-col items-center gap-2 text-center">
              ...
              <p className="text-xs text-gray-500">
                A Vision For You is a 501(c)(3) nonprofit. Your donation is tax-deductible.
              </p>
            </div>
          </div>
        </div>
