      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 border border-purple-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="signup-name" className="block text-slate-300 text-sm font-semibold mb-2">
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="signup-email" className="block text-slate-300 text-sm font-semibold mb-2">
                Email Address
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="signup-password" className="block text-slate-300 text-sm font-semibold mb-2">
                Password
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="signup-confirm-password" className="block text-slate-300 text-sm font-semibold mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500" />
