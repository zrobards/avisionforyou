        ...
        >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    maxLength={6}
                    className="w-full px-4 py-3 bg-bus-navy-light border border-gray-800 rounded-lg text-white text-center text-2xl tracking-[0.5em] font-mono placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-bus-red focus:border-transparent transition-all"
                  />
                ...
                <div className="text-center">
                  <Link
                    ...
                    className="text-sm text-bus-red hover:text-bus-red-light transition-colors"
                  >
          ...
          {!success && (
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link href="/login" className="text-bus-red hover:text-bus-red-light transition-colors">
                Back to login
              </Link>
            </p>
          )}
