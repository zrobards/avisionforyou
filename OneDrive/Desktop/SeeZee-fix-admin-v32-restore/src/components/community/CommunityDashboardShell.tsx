...
interface CommunityDashboardShellProps {
  user: CurrentUser;
  children: React.ReactNode;
}

export function CommunityDashboardShell({ user, children }: CommunityDashboardShellProps) {
  const pathname = usePathname();
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);
  const [isCollapsed, setIsCollapsed] = useState(false);

  const navItems = [
    { href: "/community", label: "Dashboard", icon: FiHome },
    { href: "/community/events", label: "Events", icon: FiCalendar },
